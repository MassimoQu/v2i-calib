...
class CoordinateConversion():
    ...
    def convert_point_3_n_infra_lidar_2_vehicle_lidar(self, points):
        ...
        implement_T_points_n_3(T_infra_lidar_2_world, points)
        implement_T_points_n_3(T_world_2_vehicle_novatel, points)
        implement_T_points_n_3(T_vehicle_novatel_2_vehicle_lidar, points)
        return points
