...
if __name__ == '__main__':
    batching_test_extrisic_from_two_box_object_list(verbose = True, filter_num = 15, using_predict_score=False, using_cpp_version=False,
