...
def save_dair_v2x_error_multi_calib():
    ...
    for infra_file_name, vehicle_file_name, infra_boxes_object_list, vehicle_boxes_object_list, T_true in CooperativeBatchingReader().generate_infra_vehicle_bboxes_object_list():
        ...
        calculated_vertex_point_precision = CorrespondingDetector(calculated_T_converted_infra_boxes_object_list, vehicle_boxes_object_list, corresponding_strategy='vertex_distance').get_distance_corresponding_precision()
        ...
        true_vertex_point_precision = CorrespondingDetector(true_T_converted_infra_boxes_object_list, vehicle_boxes_object_list, corresponding_strategy='vertex_distance').get_distance_corresponding_precision()
        true_score = CorrespondingDetector(true_T_converted_infra_boxes_object_list, vehicle_boxes_object_list).get_Yscore()
        true_score += CorrespondingDetector(true_T_converted_infra_boxes_object_list, vehicle_boxes_object_list, corresponding_strategy='vertex_distance').get_Yscore()
