...
def test_solo(cgf, inf_id, veh_id):
# DAIR-V2X
    ...
    # BBoxVisualizer_open3d().plot_boxes3d_lists_pointcloud_lists([T_result_converted_infra_boxes_object_list, filtered_vehicle_boxes_object_list], [T_result_converted_infra_pointcloud, vehicle_pointcloud], [(1, 0, 0), (0, 1, 0)])
    # BBoxVisualizer_open3d().plot_boxes3d_lists_pointcloud_lists([T_true_converted_infra_boxes_object_list, filtered_vehicle_boxes_object_list], [T_true_converted_infra_pointcloud, vehicle_pointcloud], [(1, 0, 0), (0, 1, 0)])
...
if __name__ == '__main__':
    ...
    # test_solo(cfg, '001120', '015891')
    # test_solo(cfg, '018086', '010650')
    # visualize_specific_match_T(cfg, '014725', '011886', [1, 9])
    # visualize_specific_match_T(cfg, '018086', '010650', [13, 4])
