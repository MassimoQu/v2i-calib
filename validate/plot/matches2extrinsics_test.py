...
def validate_BoxesMatches_score():
    ...
    for infra_file_name, vehicle_file_name, infra_boxes_object_list, vehicle_boxes_object_list, T_true in CooperativeBatchingReader().generate_infra_vehicle_bboxes_object_list():
        ...
        vertex_point_precision = CorrespondingDetector(calculated_T_converted_infra_boxes_object_list, vehicle_boxes_object_list, core_similarity_component='vertex_distance').get_distance_corresponding_precision()
        ...
        for match, score in matches_with_score_list:
            ...
            vertex_point_precision = CorrespondingDetector(converted_infra_boxes_object_list, vehicle_boxes_object_list, core_similarity_component='vertex_distance').get_distance_corresponding_precision()
...
def save_low_combine_accuracy_scenes_list():
    ...
    for infra_file_name, vehicle_file_name, infra_boxes_object_list, vehicle_boxes_object_list, T_true in CooperativeBatchingReader(path_data_info='/home/massimo/vehicle_infrastructure_calibration/dataset_division/common_boxes_4_data_info.json').generate_infra_vehicle_bboxes_object_list():
        ...
        cal_vertex_point_precision = CorrespondingDetector(calculated_T_converted_infra_boxes_object_list, vehicle_boxes_object_list, core_similarity_component='vertex_distance').get_distance_corresponding_precision()
        calculated_score = CorrespondingDetector(calculated_T_converted_infra_boxes_object_list, vehicle_boxes_object_list).get_Yscore()
        calculated_score += CorrespondingDetector(calculated_T_converted_infra_boxes_object_list, vehicle_boxes_object_list, core_similarity_component='vertex_distance').get_Yscore()
